$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的叫ZhuMinde</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是交互设计师</div>",2000);
	c.load("<div class='bef_comment writecode'>&nbsp;*让我来点骚气一的,看看我可以做一些什么,你准备好了吗,我要开始了</div>");
	...
	c.load("<div class='code writecode'>&nbsp;<span class='key'>max-height</span>: <span class='value'>94.5%</span>;</div>");
  	...
  	c.load("<div class='code writecode'>}</div></p>");
  	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*现在我们差不多可以开始写我的自我介绍了</div>");
	...
	w.load("<div class='writecode'>名字:朱敏德</div>");
	w.load("<div class='writecode'>年龄:14</div>");
	w.load("<div class='writecode'>职业:交互设计师</div>");
	w.load("<div class='writecode'>性别:?</div>");
	w.load("<div class='writecode'>籍贯:江西 宜春</div>");
	w.load("<div class='writecode'>居住地址:天津 南开区</div>");
	w.load("<div class='writecode'>民族:汉</div>");
	w.load("<h1 class='writecode'>联系方式:</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>邮箱:mindezhu@yeah.net</li>");
	w.load("<li class='writecode'>电话:13044950662</a></li>");
	w.load("<li class='writecode'>微信:Zhu-Minde</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能:</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通:HTML5,CSS3,javaScript</li>");
	w.load("<li class='writecode'>精通:Adobe Illustrator</li>");
    w.load("<li class='writecode'>精通:Adobe Photoshop</li>");
	w.load("<li class='writecode'>精通:Adobe AfterEffects</li>");
	w.load("<li class='writecode'>精通:Adobe Dreamweaver</li>");
	w.load("<li class='writecode'>精通:Adobe Premiere Pro</li>");
	w.load("<li class='writecode'>精通:Adobe XD</li>");
	w.load("<li class='writecode'>精通:Maxon Cinema 4D</li>");
	w.load("<li class='writecode'>熟练:HTML超文本标记语言</li>");
	w.load("<li class='writecode'>熟练:DIV+CSS代码</li>");
	w.load("<li class='writecode'>熟练的使用HTML5+CSS3,对javascript</li>");
	w.load("<li class='writecode'>有一定的了解并使用。</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目:</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='https://zhuminde.github.io/zuopinji' target='_blank'>2021年作品集</a></li>");
	w.load("<li class='writecode'><a href='http://jsrun.net/u/zhuminde' target='_blank'>代码库小飞侠</a></li>");
	w.load("<li class='writecode'><a href='https://zhuminde.github.io/webpage' target='_blank'>代码库</a></li>");
	w.load("<li class='writecode'><a href='https://zhuminde.github.io/ZhuMinde' target='_blank'>插画库</a></li>");
	w.load("<li class='writecode'><a href='https://zhuminde.gitee.io/lucia/index.html' target='_blank'>露茜娅医疗美容</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*左面的自我介绍看起来不是太令人满意，让我们先给他来点动态渲染</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*.</div>");
	c.load("<div class='comment writecode'>&nbsp;*</div>");
	c.load("<div class='comment writecode'>&nbsp;*差不多了，让我们的自我介绍动起来！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*最后非常感谢您愿意花3分钟看完我的自我介绍！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
